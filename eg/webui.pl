...
affix $lib, webui_show_browser            => [ Size_t, String, Size_t ], Bool;
...
affix $lib, webui_set_root_folder         => [ Size_t, String ], Bool;
affix $lib, webui_set_default_root_folder => [ String ], Bool;
affix $lib,
    webui_set_file_handler => [ Size_t, Callback [ [ String, Pointer [Int] ] => Pointer [Void] ] ],
    Void;
affix $lib, webui_is_shown              => [Size_t], Bool;
affix $lib, webui_set_timeout           => [Size_t], Void;
affix $lib, webui_set_icon              => [ Size_t, String, String ], Void;
affix $lib, webui_encode                => [ String ], String;
affix $lib, webui_decode                => [ String ], String;
affix $lib, webui_free                  => [ Pointer [Void] ], Void;
affix $lib, webui_malloc                => [Size_t], Pointer [Void];
affix $lib, webui_send_raw              => [ Size_t, String, Pointer [Void], Size_t ], Void;
...
affix $lib, webui_set_profile           => [ Size_t, String, String ], Void;
...
affix $lib, webui_set_tls_certificate   => [ String, String ], Bool;
affix $lib, webui_run                   => [ Size_t, String ], Void;
affix $lib, webui_script                => [ Size_t, String, Size_t, String, Size_t ], Bool;
...
affix $lib, webui_get_string_at         => [ Pointer [ webui_event_t() ], Size_t ], String;
affix $lib, webui_get_string            => [ Pointer [ webui_event_t() ] ], String;
...
affix $lib, webui_return_string         => [ Pointer [ webui_event_t() ], String ], Void;
...
webui_bind( $win, 'my_function_string', sub { warn '!!!!!!!!!!!!!!'; } );
webui_interface_bind(
    $win, 'my_function_with_response',
    sub ( $win, $event_type, $element, $event_number, $bind_id ) {
        my $n1 = webui_interface_get_int_at( $win, $event_number, 0 );
        my $n2 = webui_interface_get_int_at( $win, $event_number, 1 );
        webui_interface_set_response( $win, $event_number, '' . ( $n1 + $n2 ) );
    }
);
