...
L<Alien::Xrepo::Base> and the dist builder to keep a distribution's native dependencies inside its C<share> directory.
...
L<Affix>, L<Affix::Wrap>, L<Alien::Xmake>, L<FFI::Platypus>, L<Inline::C>; subclass the base class with
L<Alien::Xrepo::Base>
