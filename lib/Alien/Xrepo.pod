...
This module acts as an intelligent bridge between Perl and the C<xrepo> package manager. With a single
C<install> you can fetch B<shared libraries> as well as B<binary tools and interpreters> without touching a system
package manager:
...
L<Affix>, L<Affix::Wrap>, L<Alien::Xmake>, L<FFI::Platypus>, L<Inline::C>; subclass the base class with L<Alien::Xrepo::Base>
